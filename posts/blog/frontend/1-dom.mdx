...
icon: ''
image: '/posts/1-dom/new_cover.png'
tags:
  - window
  - DOM
  - BOM
...
**window는 브라우저 창을 의미하며 이 창을 제어하는 다양한 메서드들을 제공**한다는 의미였습니다.
...
사실 저희가 배우고자 했던 DOM, BOM, JS는 **window의 자식**들입니다.
...
JS를 이용하면 **브라우저의 정보에 접근**하거나, **브라우저의 여러 기능들을 제어**할 수 있습니다.
...
<img src="/posts/1-dom/230707-042112.png" width="350" />
