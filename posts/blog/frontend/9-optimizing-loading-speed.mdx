...
그리고 성능 최적화에 관심이 있으시다면 [Lighthouse를 이용한 Next.js의 성능 최적화 방법](https://www.enjoydev.life/blog/nextjs/3-performance) 포스팅에서 Lighthouse 지표를 이용한 더 구체적인 최적화 방법들을 읽어보시는 것을 추천드립니다 😀
