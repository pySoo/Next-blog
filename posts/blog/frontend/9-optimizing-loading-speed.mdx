...
그만큼 프론트엔드 개발자에게 초기 렌더링 속도 개선은 중요한 과제가 되었습니다❗️
...
그리고 성능 최적화에 관심이 있으시다면 [Lighthouse를 이용한 Next.js의 성능 최적화 방법](http://localhost:3000/blog/nextjs/3-performance) 포스팅도 추천드립니다 😀
