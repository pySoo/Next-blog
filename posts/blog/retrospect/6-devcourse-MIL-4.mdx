...
description: 프로젝트에서 효율적인 협업을 위해 시도했던 방법들과 디자인 및 공통 컴포넌트 개발 과정에서 배운 점을 기록하였습니다.
...
카카오 지도 API를 연동한 `지도 검색` 기능, 유저 간의 정보 교류를 위한 `채팅` 기능이 있습니다.
...
#### Husky [✅ 설정 방법 보러 가기](https://www.enjoydev.life/snippets/settings/husky)
...
#### Commit Template [✅ 설정 방법 보러 가기](https://www.enjoydev.life/snippets/git/hist-commit)
...
#### PR & Issue Template [✅ 설정 방법 보러 가기](https://www.enjoydev.life/snippets/git/issue-template)
...
>
  <img src="/posts/6-devcourse-MIL-4/240124-135607.png" />
  <img src="/posts/6-devcourse-MIL-4/240124-135656.png" />
</div>
...
3. **style은 props**로 주입할 수 있게 자유도를 주면 **모든 페이지에서 재사용**이 가능합니다.
...
2. 모달도 기능에 따라서 여러 개의 컴포넌트가 존재합니다. type에 따라서 모달 컴포넌트를 선언해두면 **컴포넌트를 재사용**할 수 있습니다.
